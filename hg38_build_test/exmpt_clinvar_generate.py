...
clinvar_test = pd.read_table("/mnt/datashare/home/wangzesong/clinvar/hg38_build/GRCh38_clinvar_20220719.txt")
CLIN_exmpt=[]
...
final_clinvar.to_csv('/mnt/datashare/home/wangzesong/clinvar/hg38_build/hg38_clinvar_exmpt.txt',sep='\t',index=False)
